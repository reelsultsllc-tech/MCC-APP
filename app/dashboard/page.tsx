              ...
              <GlowCard theme={theme} className="order-6 lg:col-start-2 lg:row-start-3" delay={650} loaded={loaded}>
                <div className="p-5">
                  ...
                  >
                    ...
                    <ChevronDown
                      size={15}
                      className="md:hidden flex-shrink-0 transition-transform duration-200"
                      style={{
                  ...
                  <div className={paymentsOpen ? 'block md:block mt-4 animate-slide-in-up' : 'hidden md:block md:mt-4'}>
                      {/* Bar chart */}
